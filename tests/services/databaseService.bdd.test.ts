...
import { FusedData, CustomData } from '../../src/types';
      ...
      it('Given data with incorrect types', async () => {
        ...
        const invalidData = {
          character: {
            ...
            height: 'invalid', // Should be numeric string
            mass: 'invalid', // Should be numeric string
            hair_color: 'blond',
            skin_color: 'fair',
            eye_color: 'blue',
            birth_year: '19BBY',
          ...
          planet: {},
          weather: {},
          fusion_timestamp: 'not-a-number' // Should be number
        } as any;
